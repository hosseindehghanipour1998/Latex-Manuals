...
\subsection{B}
\begin{doublespace}
$-10 = \log_{10}{\alpha} \Longrightarrow -1 = \log_{10}{\alpha} \Longrightarrow \alpha = 10^{-1}$\\
$\alpha_1 + \alpha_2 = 2 * 10^{-1} W \Longrightarrow $ Total Power = $ 200 mW$
\end{doublespace}
\line(1,0){450}
